...
let URL = "https://ms-ol-demo.rnd.gemaltodigitalbankingidcloud.com"

// IdCloud Server Tenant ID
#if DEBUG
let TENANT_ID = "mobile_client_testing"
#else
let TENANT_ID = "icloudpartners"
#endif
...
struct SecureLogPublicKey {
    ...
    static let publicKeyExponent: [CUnsignedChar] = [ 0x01, 0x00, 0x01 ]
}
